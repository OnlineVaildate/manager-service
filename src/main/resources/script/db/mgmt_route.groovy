...
databaseChangeLog(logicalFilePath: 'script/db/mgmt_routeroute.groovy') {
    changeSet(author: 'superleader8@gmail.com', id: '2018-03-21-mgmt_route') {
    ...
    changeSet(id: '2018-04-19-add-unique-constraint', author: 'guokai.wu.work@gmail.com') {
        addUniqueConstraint(tableName: 'mgmt_route', columnNames: 'name')
    }
}